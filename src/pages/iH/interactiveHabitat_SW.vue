    ...
    <div style="width: 66.3%">
        ...
        <div class="row q-py-xs justify-evenly no-wrap">
          ...
          <q-card class="q-pa-sm" style="width: 24%">
            <div class="q-px-sm">
              ...
              <h>6.56</h> <b> ± 2.86 µg/cm<sup>2</sup></b>
              <div class="row justify-end">
                (n = 4)
              </div>
              Organic matter: <br />
              <h>5.56</h> <b> ± 2.10 mg/cm<sup>2</sup></b>
              <div class="row justify-end">
                (n = 4)
              </div>
            </div>
      ...
      <div class="row no-wrap justify-around">
        ...
        <q-card class="q-ma-md" style="width: 24%; height: 40vh">
          ...
          <q-img src="~/assets/SiteImage/Peng Chau.png" height="25vh" basic />
          <div class="row bg-white absolute-bottom">
            <q-icon
              class="q-pa-sm"
              style="font-size: 2.5rem"
        ...
        >
          <q-card>
            <q-bar style="height: 40px" class="bg-indigo text-bold">
              ...
              <div class="text-indigo-1">Southwestern region</div>
              <div class="text-white">>> Tai Long Wan</div>
              <q-space />
        ...
        >
          <q-card>
            <q-bar style="height: 40px" class="bg-indigo text-bold">
              <div class="text-indigo-2">Site introduction |</div>
              <div class="text-indigo-1">Southwestern region</div>
              <div class="text-white">>> Shui Tseng</div>
              <q-space />
              <q-btn dense flat class="text-white" icon="close" v-close-popup>
                <q-tooltip>Close</q-tooltip>
              </q-btn>
        ...
        >
          <q-card>
            <q-bar style="height: 40px" class="bg-indigo text-bold">
              <div class="text-indigo-2">Site introduction |</div>
              <div class="text-indigo-1">Southwestern region</div>
              <div class="text-white">>> Peng Chau</div>
              <q-space />
        ...
        >
          <q-card>
            <q-bar style="height: 40px" class="bg-indigo text-bold">
              <div class="text-indigo-2">Site introduction |</div>
              <div class="text-indigo-1">Southwestern region</div>
              <div class="text-white">>> Pui O</div>
              <q-space />
              <q-btn dense flat class="text-white" icon="close" v-close-popup>
                <q-tooltip>Close</q-tooltip>
              </q-btn>
...
export default {
  ...
  computed: {
    ...
    Table_SWPC() {
      return this.$store.state.storeRegionTable.Table_SWPC;
    },
    Table_SWPO() {
      return this.$store.state.storeRegionTable.Table_SWPO;
    }
  }
};
</script>
