    ...
    <div id="sidebar" class="col-4 bg-grey-6">
      <q-card dark bordered class="bg-blue-grey-13 my-card">
        ...
        <q-card-section>
          ...
          perferendis dignissimos repudiandae! Corrupti asperiores a amet
          maiores quisquam dolor fugit, eveniet et sed aut molestiae possimus
          odio iure vel voluptate.
        </q-card-section>
      </q-card>
    </div>
