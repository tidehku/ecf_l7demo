    ...
    <div id="sidebar" class="col-4 bg-grey-6">
      <q-card dark bordered class="bg-blue-grey-13 my-card">
        ...
        <q-card-section>
          ...
          quod provident consequuntur ipsa illum exercitationem laudantium iusto
          accusantium deserunt. Quod dignissimos perspiciatis iure consequuntur
          eos reprehenderit pariatur, a cum aliquid.
        </q-card-section>
      </q-card>
    </div>
