  ...
  <q-page class="q-gutter-md bg-grey-3">
    <div class="row">
      ...
      <div class="q-pa-md col-5">
        ...
        />
        <div class="q-px-md bg-black text-white">Map showing demarcation of regions and location of sampling sites within each region.</div>
      </div>
    </div>
    ...
    <div class="q-gutter-md bg-indigo-5 text-white">
      ...
      <div class="row justify-evenly">
        ...
        >
          ...
          <div class="q-px-md bg-black text-white">Morning survey in Shek O ....</div>
          <q-img src="~/assets/method3.png" />
          <div class="q-px-md bg-black text-white">The ECF team surveying rocky shores in Luk Keng</div>
          <q-img src="~/assets/method4.png" />
          <div class="q-px-md bg-black text-white">The ECF team surveying rocky shores in Tai O</div>
        </div>
        <div
          class="q-px-lg"
          style="width:60%"
        >
          <div class="text-subtitle1"> {{ method1 }}</div>
          <br /> <br />
          <div class="text-subtitle1"> {{ method2 }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="q-gutter-md">
      ...
      <div class="row justify-evenly">
        ...
        <div class="col-6">
          ...
          />
          <div class="q-px-md bg-black text-white">Custom-built wavelogger (left image) and rugged temperature loggers (right image) deployed on shores to record wave force and rock surface temperature. </div>
    ...
    <div class="q-pa-md bg-indigo">
      ...
      <div class="text-subtitle1 text-center text-white">
        This glossary outlines the definitions of the biological and physical terms/measurements adopted in this survey
      </div>
    </div>
    ...
    return {
      ...
      phyGlossary: [
        ...
        },
        {
          ...
          description: `In the regional landing page where you can select information of the four study sites within that region, there is a “wave exposure icon” next to each site.  As we deliberately selected four sites with different wave exposures within a region, the icon indicates the relative wave exposure of that site: Most exposed within the region: Intermediately exposed within the region:Least exposed within the region: `,
        },
      ],
    };
  },
