  ...
  <q-page class="justify-center">
    <q-bar elevated class="bg-blue-9 text-white">
      <div class="text-bold row justify-center">
        Physical dashboard of Tai Tam, Southern region
      </div>
      <q-space />
      <q-btn
        dense
...
export default {
  data() {
    return {
      ...
      Chla1: chlaData.SOTTChla1,
      OM1: omData.SOTTOm1,
      Chla2: chlaData.SOTTChla2,
      OM2: omData.SOTTOm2
    };
  },
  mounted() {
    let temp =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vSjPMWbetTCcuxv8lIrnbxjA0EUqdNJRcdyOMVhjdQnOovT7OK5i3e2GrHtoPUcrTPtuHjvJHSbd919/pub?gid=0&single=true&output=csv";

    let bar =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vSjPMWbetTCcuxv8lIrnbxjA0EUqdNJRcdyOMVhjdQnOovT7OK5i3e2GrHtoPUcrTPtuHjvJHSbd919/pub?gid=1015283391&single=true&output=csv";
