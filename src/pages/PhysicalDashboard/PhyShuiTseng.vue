  ...
  <q-page class="justify-center">
    <q-bar elevated class="bg-blue-9 text-white">
      <div class="text-bold row justify-center">
        Physical dashboard of Shui Tseng, Southwestern region
      </div>
      <q-space />
      <q-btn
        dense
...
export default {
  data() {
    return {
      ...
      Chla1: chlaData.SWSTChla1,
      OM1: omData.SWSTOm1,
      Chla2: chlaData.SWSTChla2,
      OM2: omData.SWSTOm2
    };
  },
  mounted() {
    let temp =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vR9JNdZ3zYgst2FPagdeFifPvqO7kI3Mm2XtEj5Hir0vfCycMdXAcULaMoH-Hvzvoz8SXbWZ50xiTyP/pub?gid=0&single=true&output=csv";

    let bar =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vR9JNdZ3zYgst2FPagdeFifPvqO7kI3Mm2XtEj5Hir0vfCycMdXAcULaMoH-Hvzvoz8SXbWZ50xiTyP/pub?gid=1470336517&single=true&output=csv";
