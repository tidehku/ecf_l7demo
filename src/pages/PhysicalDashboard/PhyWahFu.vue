  ...
  <q-page class="justify-center">
    <q-bar elevated class="bg-blue-9 text-white">
      <div class="text-bold row justify-center">
        Physical dashboard of Wah Fu, Southern region
      </div>
      <q-space />
      <q-btn
        dense
...
export default {
  data() {
    return {
      ...
      Chla1: chlaData.SOWFChla1,
      OM1: omData.SOWFOm1,
      Chla2: chlaData.SOWFChla2,
      OM2: omData.SOWFOm2
    };
  },
  mounted() {
    ...
    let bar =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vRkp2ABVz8M6rqf6LTIruh0GXHeb-fAy8ydeA6JLa-n-6WZ1E0_EU-NEi6yk4HjRot-U3iQRtaZPjsf/pub?gid=804630854&single=true&output=csv";
