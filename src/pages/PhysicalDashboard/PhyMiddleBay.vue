  ...
  <q-page class="justify-center">
    <q-bar elevated class="bg-blue-9 text-white">
      <div class="text-bold row justify-center">
        Physical dashboard of Middle Bay, Southern region
      </div>
      <q-space />
      <q-btn
        dense
...
export default {
  data() {
    return {
      ...
      Chla1: chlaData.SOMBChla1,
      OM1: omData.SOMBOm1,
      Chla2: chlaData.SOMBChla2,
      OM2: omData.SOMBOm2
    };
  },
  mounted() {
    let temp =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vTBAjtgAtH08RZfoy7-4QRATTex5lPn4m99Gze-nhOInVFobrV8BlkJkRX92x3rGszdDpt7LKnAPi0K/pub?gid=0&single=true&output=csv";

    let bar =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vTBAjtgAtH08RZfoy7-4QRATTex5lPn4m99Gze-nhOInVFobrV8BlkJkRX92x3rGszdDpt7LKnAPi0K/pub?gid=2126461850&single=true&output=csv";
