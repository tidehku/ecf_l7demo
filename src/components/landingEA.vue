          ...
          <div class="row no-wrap justify-evenly">
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.highShoreTempN }})
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.lowShoreTempN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingEA.winter2020.chlaDelta }} µg/cm<sup>2</sup></b
                  >
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.chlaN }})
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingEA.winter2020.omDelta }} mg/cm<sup>2</sup></b
                  >
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.omN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue q-pl-md">
                    {{ landingEA.winter2020.waveMin }}
                  </div>
                  &nbsp;
                  <b class="self-center">km</b>
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.waveN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.mobileN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.winter2020.sessileN }})
                </div>
              </q-card-section>
            </q-card>
          </div>
          ...
          <div class="row no-wrap justify-evenly">
            <q-card class="q-pa-sm bg-white" style="width: 20%"> 
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.highShoreTempN }})
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.lowShoreTempN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingEA.summer2021.chlaDelta }} µg/cm<sup>2</sup></b
                  >
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.chlaN }})
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingEA.summer2021.omDelta }} mg/cm<sup>2</sup></b
                  >
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.omN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue q-pl-md">
                    {{ landingEA.summer2021.waveMin }}
                  </div>
                  &nbsp;
                  <b class="self-center">km</b>
                </div>
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.waveN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.mobileN }})
                </div>
              </q-card-section>
            </q-card>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 20%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row justify-end">
                  (n = {{ landingEA.summer2021.sessileN }})
                </div>
              </q-card-section>
            </q-card>
          </div>
