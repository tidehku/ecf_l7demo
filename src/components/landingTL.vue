          ...
          <div class="row no-wrap justify-evenly">
            <q-card class="q-pa-sm bg-white">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue">
                    {{ landingTL.winter2020.highShoreTemp }}
                  </div>
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingTL.winter2020.highShoreTempDelta }} ℃</b
                  >
                </div>
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue">
                    {{ landingTL.winter2020.lowShoreTemp }}
                  </div>
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingTL.winter2020.lowShoreTempDelta }} ℃</b
                  >
                </div>
                <div class="row justify-end">
            ...
            <q-card class="q-pa-sm bg-white" style="width: 26%">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue">{{ landingTL.winter2020.om }}</div>
                  &nbsp;
                  <b class="self-center">
              ...
              <q-card-section class="q-pt-none">
                <div class="row no-wrap">
                  ...
                  <div class="landingValue q-pl-md">
                    {{ landingTL.winter2020.mobileMax }}
                  </div>
                </div>
              </q-card-section>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 18%">
              ...
              <q-card-section class="q-pt-none">
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <div class="landingValue q-pl-md">
                    {{ landingTL.winter2020.sessileMax }}
                  </div>
                </div>
              </q-card-section>
          ...
          <div class="row no-wrap justify-evenly">
            <q-card class="q-pa-sm bg-white">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue">
                    {{ landingTL.summer2021.highShoreTemp }}
                  </div>
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingTL.summer2021.highShoreTempDelta }} ℃</b
                  >
                </div>
                <div class="row justify-end">
              ...
              <q-card-section class="q-pt-none">
                ...
                <div class="row no-wrap">
                  <div class="landingValue">
                    {{ landingTL.summer2021.lowShoreTemp }}
                  </div>
                  &nbsp;
                  <b class="self-center">
                    ± {{ landingTL.summer2021.lowShoreTempDelta }} ℃</b
                  >
                </div>
                <div class="row justify-end">
            ...
            <q-card class="q-pa-sm bg-white" style="width: 26%">
              ...
              <q-card-section class="q-pt-none">
                <span style="font-size: 1.2rem">Organic matter: </span>
                <div class="row no-wrap">
                  <div class="landingValue">{{ landingTL.summer2021.om }}</div>
                  &nbsp;
                  <b class="self-center">
            ...
            <q-card class="q-pa-sm bg-white" style="width: 18%">
              ...
              <q-card-section class="q-pt-none">
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <div class="landingValue q-pl-md">
                    {{ landingTL.summer2021.mobileMax }}
                  </div>
                </div>
              </q-card-section>
            ...
            <q-card class="q-pa-sm bg-white" style="width: 18%">
              ...
              <q-card-section class="q-pt-none">
                <div class="row no-wrap">
                  ...
                  &nbsp;
                  <div class="landingValue q-pl-md">
                    {{ landingTL.summer2021.sessileMax }}
                  </div>
                </div>
              </q-card-section>
...
<script>
import landingTL from "./landingTL";
export default {
  data() {
    return {
      panel: "winter2020",
